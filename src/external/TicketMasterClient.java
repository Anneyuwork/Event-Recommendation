...
public class TicketMasterClient {
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		//create connection based on url, setRequestMethod, and send request!
		try {
			...
			connection.setRequestMethod("GET"); //set method is GET!
			connection.connect(); // create connect, send request!
			...
			//2) responseBody -->connection.getInputStrean()--> return responseBody
		...
		// StringBuilder responseBody to JSONObject 
		try {
